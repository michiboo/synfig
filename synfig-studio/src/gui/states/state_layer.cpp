...
/* === G L O B A L S ======================================================= */
StateLayer studio::state_layer;


/* === C L A S S E S & S T R U C T S ======================================= */

class studio::StateLayer_Context : public sigc::trackable
{
...
public:
	...
	StateLayer_Context(CanvasView* canvas_view);
	~StateLayer_Context();
...
};	// END of class StateLayer_Context

/* === M E T H O D S ======================================================= */

StateLayer::StateLayer():
	Smach::state<StateLayer_Context>("zoom")
{
	insert(event_def(EVENT_STOP,&StateLayer_Context::event_stop_handler));
	insert(event_def(EVENT_REFRESH,&StateLayer_Context::event_refresh_handler));
	insert(event_def(EVENT_WORKAREA_MOUSE_BUTTON_DOWN,&StateLayer_Context::event_mouse_click_handler));
	//insert(event_def(EVENT_WORKAREA_MOUSE_BUTTON_DRAG,&StateLayer_Context::event_mouse_click_handler));
	insert(event_def(EVENT_WORKAREA_BOX,&StateLayer_Context::event_mouse_click_handler));
	//insert(event_def(EVENT_WORKAREA_BUTTON_CLICK,&StateLayer_Context::event_mouse_click_handler));
	insert(event_def(EVENT_WORKAREA_MOUSE_BUTTON_UP,&StateLayer_Context::event_mouse_click_handler));
}
...
StateLayer_Context::StateLayer_Context(CanvasView* canvas_view):
...
StateLayer_Context::~StateLayer_Context()
{
...
Smach::event_result
StateLayer_Context::event_stop_handler(const Smach::event& /*x*/)
{
...
Smach::event_result
StateLayer_Context::event_refresh_handler(const Smach::event& /*x*/)
{
	return Smach::RESULT_ACCEPT;
}

Smach::event_result
StateLayer_Context::event_mouse_click_handler(const Smach::event& x)
{
